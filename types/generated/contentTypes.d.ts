...
export interface ApiExperienceExperience extends Schema.CollectionType {
  ...
  attributes: {
    date: Attribute.String &
      Attribute.Required &
      Attribute.DefaultTo<'From 08/19'>;
...
export interface ApiHeroTextHeroText extends Schema.SingleType {
  collectionName: 'hero_texts';
  info: {
    singularName: 'hero-text';
    pluralName: 'hero-texts';
  ...
  attributes: {
    content: Attribute.Text &
      Attribute.DefaultTo<'["Hi there"], ["This is an example"]'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    RepositoryLink: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSkillSkill extends Schema.CollectionType {
  ...
  attributes: {
    ...
    skillgroup: Attribute.Relation<
      'api::skill.skill',
      'oneToOne',
      'api::skillgroup.skillgroup'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiSkillgroupSkillgroup extends Schema.CollectionType {
  collectionName: 'skillgroups';
  info: {
    singularName: 'skillgroup';
    pluralName: 'skillgroups';
...
export interface ApiSocialSocial extends Schema.CollectionType {
  ...
  attributes: {
    service: Attribute.String & Attribute.DefaultTo<'Twitter'>;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::skillgroup.skillgroup': ApiSkillgroupSkillgroup;
